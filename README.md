...
在项目目录下启动 Claude Code，自然语言即可驱动所有功能。
...
| 估值分析 | "茅台现在估值合理吗" |
| 综合报告 | "给我一份茅台的全面分析报告" |
| 宏观环境 | "当前宏观环境怎么样" / "看一下中美宏观数据" |
| 情绪分析 | "茅台最近的新闻情绪怎么样" |
| 年报分析 | "分析一下茅台最新年报" |
| 风险评估 | "茅台的风险有多大" |
| 基准对比 | "茅台跑赢大盘了吗" |
| 情景分析 | "茅台最坏能跌到哪" |
| 跨市场联动 | "现在是Risk-On还是Risk-Off" |
| 市场概览 | "扫一眼全球市场" / "商品最近表现怎么样" |
| 回顾历史判断 | "回顾一下之前对茅台的分析" |
| 股息率走势 | "看一下招行股息率走势"/"招行股息率曲线" |
| 当前股息率 | "招行现在股息率多少" |
...
典型工作流：先抓数据 → 技术面分析 → 基本面估值 → 综合报告出结论。宏观背景用宏观评估 + 市场概览兜底。
